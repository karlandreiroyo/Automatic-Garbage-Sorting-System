...
Your app is at **https://brave-adaptation-production.up.railway.app/** (no localhost). You typically have **two services**: the **frontend** (that URL) and the **backend** (Node, with its own Railway URL). Both need their own variables.
...
1. In Railway, open the service that serves **https://brave-adaptation-production.up.railway.app/** (your frontend).
...
| Variable | Example |
|----------|---------|
| `FRONTEND_URL` | `https://brave-adaptation-production.up.railway.app` |
