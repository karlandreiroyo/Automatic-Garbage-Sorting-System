/**
 * Map raw ML labels to /api/hardware/sort waste_type values.
 * Keep algorithm aligned with frontend/src/utils/mlLabelClassify.js
 */

const VALID = ['Recycle', 'Non-Bio', 'Biodegradable', 'Unsorted'];

function classifyRawLabelToWasteType(raw) {
...
module.exports = {
  classifyRawLabelToWasteType,
  VALID_WASTE_TYPES: VALID,
};
