...
/**
 * GET /api/admin/recorded-items
 * Query: bin_id (required), category (optional - e.g. Recyclable, Biodegradable)
 * Returns waste_items for the given bin from Supabase (same data collector records).
 * Admin/superadmin only. Used by admin Bin Monitoring "Recorded Items" section.
 */
router.get('/', requireAuth, async (req, res) => {
  try {
    ...
    if (error) {
      console.error('admin recorded-items error:', error.message);
